...
import com.hilifecare.di.components.DaggerDeviceControlComponent;
...
public class DeviceControlActivity extends BaseActivity<DeviceControlPresenter> implements DeviceControlView, HasComponent<DeviceControlComponent> {
    ...
    protected void injectModule() {
        deviceControlComponent = DaggerDeviceControlComponent.builder().applicationComponent(App.get(this).getComponent()).deviceControlModule(new DeviceControlModule(this)).build();
        deviceControlComponent.inject(this);
    }

    public PresenterFactory<DeviceControlPresenter> getPresenterFactory() {
        return () -> deviceControlPresenter;
    }
...
//        setContentView(R.layout.gatt_services_characteristics);
        ...
        setmDeviceAddress(mDeviceAddress);
        Toast.makeText(this,"스마트밴드와 연결되었습니다.", Toast.LENGTH_LONG).show();
        deviceControlPresenter.insertSmartBandAddress(mDeviceAddress);
        finish();
