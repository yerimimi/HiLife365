...
public class BluetoothLeService extends Service {
    ...
    public final static String SYNC_DATA =
            "com.example.bluetooth.le.SYNC_DATA";
    ...
    public final static String SPO2_DATA =
            "com.example.bluetooth.le.SPO2_DATA";
    public final static String SPEED_DATA =
            "com.example.bluetooth.le.SPEED_DATA";
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            if(sync_flag == 1) {    //sync 전송
                ...
                intent.putExtra(SPO2_DATA, String.valueOf(characteristic.getIntValue(format, 3)));
                intent.putExtra(SPEED_DATA, String.valueOf(characteristic.getIntValue(format, 4)));
            } else {                //실시간 전송
                intent.putExtra(SYNC_DATA, String.valueOf(characteristic.getIntValue(format, 0)));
                intent.putExtra(HR_DATA, String.valueOf(characteristic.getIntValue(format, 3)));
                VisualStopwatch.getInstance().reset();
                intent.putExtra(SPO2_DATA, String.valueOf(characteristic.getIntValue(format, 4)));
                intent.putExtra(SPEED_DATA, String.valueOf(characteristic.getIntValue(format, 5)));
            }
        } else {
